...
- Patch revision: `creality-cfs-orca-2.4.0-beta-r3-20260616`
...
- Timelapse control remains visible for Creality/time-lapse-capable printers and includes an **Off** option.
